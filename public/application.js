...
/***/ (function(module, exports, __webpack_require__) {
	...
	var boardActions = __webpack_require__(36);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(48);
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(ui.onSignUpSuccess, gameEvents.listBoards).catch(ui.onError);
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  var data = getFormFields(this);
	  api.signIn(data).done(ui.onSignInSuccess, gameEvents.listBoards).catch(ui.onError);
	};
	...
	var onChangePW = function onChangePW(event) {
	  ...
	  var data = getFormFields(this);
	  api.changePassword(data).then(ui.onChangePWSuccess).catch(ui.onPWError);
	};

	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  api.signOut().done(ui.signOutSuccess, gameEvents.clearCurrentBoard()).catch(ui.onError);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $message = $('.message');
	var store = __webpack_require__(9);
	var showFooter = __webpack_require__(11);
	var showSignInUp = __webpack_require__(31);
	var addBoardList = __webpack_require__(32);
	var aboutShoop = __webpack_require__(34);
	var shoopRules = __webpack_require__(35);
	...
	var onSignInSuccess = function onSignInSuccess(data) {
	  ...
	  var boardListHTML = addBoardList();
	  var shoopRulesHTML = shoopRules();
	...
	var signOutSuccess = function signOutSuccess() {
	  ...
	  var signInHTML = showSignInUp();
	  $('.wrapper').append(signInHTML);
	  var aboutShoopHTML = aboutShoop();
	  $('.shoop-rules').remove();
	...
	var onPWError = function onPWError() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<footer class=\"footer\">\n    <h5> Account Managment </h5>\n    <div class=\"row\">\n        <div class=\"col-xs-6\">\n            <button type=\"button\" class=\"btn btn-default change-pw-button\" data-toggle=\"modal\" data-target=\"#changePW\">\nChange Password\n</button>\n        </div>\n        <div class=\"col-xs-6\">\n            <form class='userEvents sign-out' id='sign-out'>\n                <button type=\"submit\" class=\"btn btn-default sign-out\">Sign Out</button>\n            </form>\n        </div>\n    </div>\n\n    <div class=\"modal fade\" id=\"changePW\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"changePWLabel\">\n        <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n                <div class=\"modal-header\">\n                    <h4 class=\"modal-title\" id=\"changePWLabel\">Change your PW</h4>\n                </div>\n                <div class=\"modal-body\">\n\n                    <form class='userEvents' id='change-pw'>\n                        <div class=\"form-group\">\n                            <input type=\"password\" name=\"passwords[old]\" id=\"old-pw\" placeholder=\"Enter old PW\">\n                            <input type=\"password\" name=\"passwords[new]\" id=\"new-pw\" placeholder=\"Enter new PW\">\n                        </div>\n                        <button type=\"submit\" class=\"btn btn-default\">Change PW</button>\n                    </form>\n                </div>\n                <div class=\"modal-footer\">\n                    <div class=\"row\">\n                        <div class=\"col-xs-8\">\n                            <p id=\"changePWMessage\" class=\"message\"> </p>\n                        </div>\n                        <div class=\"col-xs-4\">\n                            <button type=\"button\" class=\"btn btn-default close-form\" data-dismiss=\"modal\">Close Form</button>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</footer>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<aside class=\"aside aside-2\" id=\"signInUp\">\n  <div class=\"sign-up-div\">\n  <h2> Sign Up </h2>\n    <form class='userEvents' id='sign-up'>\n        <div class=\"form-group\">\n            <input type=\"text\" name=\"credentials[email]\" id=\"signUpEmail\" placeholder=\"Enter Email\">\n            <input type=\"password\" name=\"credentials[password]\" id=\"signUpPassword\" placeholder=\"Enter Password\">\n            <input type=\"password\" name=\"credentials[password_confirmation]\" id=\"signUpPassword_confirmation\" placeholder=\"Confirm Password\">\n        </div>\n        <button type=\"submit\" class=\"btn btn-default\">Sign Up</button>\n    </form>\n  </div>\n\n    <h2>Sign in</h2>\n    <form class='userEvents' id='sign-in'>\n        <div class=\"form-group\">\n            <input type=\"text\" name=\"credentials[email]\" id=\"email\" placeholder=\"Enter Email\">\n            <input type=\"password\" name=\"credentials[password]\" id=\"password\" placeholder=\"Enter PW\">\n        </div>\n        <button type=\"submit\" class=\"btn btn-default\">Sign In</button>\n    </form>\n\n</aside>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<article class=\"main\">\n    <p id=\"listBoards\"> Board Managment</p>\n    <ul class=\"flex-container game-board\" id=\"game-board\">\n\n    </ul>\n    <div class=\"new-game-button-div\">\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"newGameForm","data":data,"indent":"          ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "        </div>\n</article>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "\n\n <button type=\"button\" class=\"newGameButton btn btn-primary btn-lg btn-block\" data-toggle=\"modal\" data-target=\"#newGame\">\n    New Game\n    </button>\n\n\n          <div class=\"modal fade\" id=\"newGame\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"newGameLabel\">\n            <div class=\"modal-dialog\" role=\"document\">\n              <div class=\"modal-content\">\n                <div class=\"modal-header\">\n                  <h4 class=\"modal-title\" id=\"newGameLabel\">Create a new Shoop Board!</h4>\n                </div>\n                <div class=\"modal-body\">\n                  <form class='userEvents' id='myForm'>\n                      <div class=\"form-group\">\n                          <input id=\"newGameName\" type=\"text\" name=\"board[title]\" placeholder=\"Enter title\">\n                      </div>\n                      <button type=\"submit\" class=\"btn btn-default\">Create the Board</button>\n                  </form>\n                </div>\n                <div class=\"modal-footer\">\n                  <div class=\"row\">\n                    <div class=\"col-xs-8\">\n                      <p id=\"newGameMessage\"> </p>\n                    </div>\n                    <div class=\"col-xs-4\">\n                      <button type=\"button\" class=\"btn btn-default close-form\" data-dismiss=\"modal\">Close Form</button>\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"about-shoop\">\n  <h4> About Shoop </h4>\n  <blockquote>\n      <p>\"Shoop\" is the lead single released from Salt-N-Pepa's fourth studio album, Very Necessary.</p>\n      <footer><cite>Wikipidea</cite></footer>\n  </blockquote>\n  <p>\n    This app is anything but necessary.\n  </p>\n  <blockquote>\n      <p> Question: \"What does 'Shoop' mean in the Salt N Pepa song Shoop Ba Doop?\"</p>\n      <p>Answer: \"Doesn't mean anything. It's just something that's fun to sing.\"</p>\n      <footer><cite>Cheryl James - NY Daily News Interview</cite></footer>\n  </blockquote>\n  <p>\n    It is intended to meet the requirments of WDI projct two...and entertain it's createor.\n  </p>\n  <p>\n    The title shoop was chosen, because SEE ANSWER ABOVE!\n  </p>\n  <p>\n    Slightly more serious answer - this is intended to be a fun way to make prety pictures/animations.\n  </p>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"shoop-rules\">\n    <h4> Rules of Shoop </h4>\n    <p> To start a new board click the New Game button below</p>\n    <p> To access a saved board click on one of your boards below</p>\n    <p> Once editing a board, click the \"Return to Board List\" button to return to your saved list </p>\n    <p> When you're editing a board make sure to save often! </p>\n    <p> There are two kinds of animation(clicking on most other buttons will end an animation)</p>\n    <p> 1. Blink board, that will just alternate colors</p>\n    <p> 2. Make the board SHOOP- or a modified version of Conways game of life </p>\n    <p> Modified b/c it has never been varified against another source.</p>\n    <p> Shoop Animation Rules:</p>\n    <ul>\n        <li> If a blue(alive) cell is bordered by fewer than 2 blue(alive) cells it turns red(dies)\n        <li> If a blue(alive) cell is borderd by more than 3 blue(alive) cells it turns red(dies)\n        <li> If a red(dead) cell is borderd by three blue(alive) cells it turns blue(IT LIVES)\n        <li> Otherwise...my favorite thing happens...nada\n    </ul>\n\n\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createBoardArrays = __webpack_require__(37);
	var renderBoards = __webpack_require__(40);
	var api = __webpack_require__(43);
	var ui = __webpack_require__(44);
	var board = __webpack_require__(38);
	var getFormFields = __webpack_require__(48);
	var gameRules = __webpack_require__(39);
	var videoShooping = __webpack_require__(49);
	var nIntervId = void 0;

	var clearCurrentBoard = function clearCurrentBoard() {
	  onStopBoard();
	  $('#game-board').remove();
	  $('#board-title').remove();
	  $('.video').remove();
	...
	var onRandomizeBoard = function onRandomizeBoard() {
	  clearCurrentBoard();
	...
	var onConwayBoard = function onConwayBoard() {
	  onStopBoard();
	  var videoHTML = videoShooping();
	  $('.aside-1').append(videoHTML);
	  nIntervId = setInterval(gameOfLife, 1000);
	};
	var blinkBoard = function blinkBoard() {
	...
	var onGetBoard = function onGetBoard(li) {
	  var boardID = this.id;
	  api.getBoard(this.id).done(ui.getBoardSuccsess, renderBoards.renderBoard).catch(ui.failure);
	};

	var onBlinkBoard = function onBlinkBoard() {
	  onStopBoard();
	...
	var onStopBoard = function onStopBoard() {
	  $('.video').remove();
	...
	var listBoards = function listBoards() {
	  api.getBoards().done(ui.getGamesSuccesss).catch(ui.failure);
	};

	var onListBoards = function onListBoards(event) {
	  event.preventDefault();
	  clearCurrentBoard();
	  listBoards();
	};

	var onSaveBoard = function onSaveBoard() {
	  event.preventDefault();
	  onStopBoard();
	  $('.save-message').remove();
	  var data = {};
	  data.cells = JSON.stringify(board.cellsStore);
	  api.saveBoard(data).then(ui.saveGameSuccess).catch(ui.failure);
	};

	var onSaveNewBoard = function onSaveNewBoard() {
	  event.preventDefault();
	  var titlePrep = getFormFields(this);
	  var title = titlePrep.board.title;
	  ...
	  data.cells = JSON.stringify(board.cellsStore);
	  data.title = title;
	  api.saveNewBoard(data).done(ui.newGameSucess, renderBoards.renderBoard).catch(ui.failure);
	};

	var onDeleteBoard = function onDeleteBoard() {
	  api.deleteBoard().done(clearCurrentBoard, listBoards).catch(ui.failure);
	};

	var onBoardClick = function onBoardClick(li) {
	  var clickedClass = $(this).attr("class").split(" ");

	  var xPrep = clickedClass[3].split('');
	  var x = void 0;
	  if (xPrep.length === 4) {
	    x = (xPrep[2] + xPrep[3]) * 1;
	  } else {
	  ...
	  var yPrep = clickedClass[2].split('');
	  var y = void 0;
	  if (yPrep.length === 4) {
	    y = (yPrep[2] + yPrep[3]) * 1;
	  } else {
	...
	module.exports = {
	  ...
	  onBlinkBoard: onBlinkBoard,
	  onStopBoard: onStopBoard,
	  onListBoards: onListBoards,
	  onSaveBoard: onSaveBoard,
	  onGetBoard: onGetBoard,
	  onSaveNewBoard: onSaveNewBoard,
	  onDeleteBoard: onDeleteBoard,
	  listBoards: listBoards,
	  onBoardClick: onBoardClick,
	  onConwayBoard: onConwayBoard,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Cell = function Cell(xCord, yCord) {
	  this.xCord = xCord;
	  this.yCord = yCord;
	...
	var newCellValues = function newCellValues(board) {
	  var result = board;
	...
	var newBoard = function newBoard() {
	  var blankCanvas = new Board(28, 28);
	  board.cellsStore = newCellValues(blankCanvas);
	};
	// method to initalize the board with random colors
	var randomizeCellValues = function randomizeCellValues(board) {
	  var result = board;
	  for (var x = 0; x < board.length; x++) {
	    for (var y = 0; y < board[x].length; y++) {
	      board[x][y] = new Cell(x, y);
	...
	var randomizeBoard = function randomizeBoard() {
	  var blankCanvas = new Board(28, 28);
	  board.cellsStore = randomizeCellValues(blankCanvas);
	  // return board.boardStore
	};

	var updateCellValues = function updateCellValues(twoDimArray, gameLogic) {
	  // HUGE design flaw here, I don't know who "variablize" the 23x23
	  var board = Board(28, 28);
	...
	var assignBoardStore = function assignBoardStore(data) {
	  var board = {};
	...
	module.exports = {
	  ...
	  newBoard: newBoard,
	  assignBoardStore: assignBoardStore
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var flipValue = function flipValue(cell) {
	...
	var doesCellExist = function doesCellExist(num) {
	  var result = void 0;
	  if (num < 0) {
	    result = false;
	...
	var isAlive = function isAlive(value) {
	  return value > 1;
	};

	var conwaysRules = function conwaysRules(cell) {
	  var testArray = createBordarArray(cell);
	  var arrayForChecking = testArray.filter(isAlive);
	...
	module.exports = {
	  flipValue: flipValue,
	  createBordarArray: createBordarArray,
	  conwaysRules: conwaysRules
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createBoardTemplate = __webpack_require__(41);
	var addBoardTitle = __webpack_require__(42);
	var board = __webpack_require__(38);

	var renderBoard = function renderBoard() {
	  var titlePrep = board.boardStore;
	  var title = titlePrep.board.title;
	  var titleHTML = addBoardTitle({ title: title });
	  $('#listBoards').append(titleHTML);
	  var cells = board.cellsStore;
	  var boardHTML = createBoardTemplate({ cells: cells });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "        <li class=\"flex-item board-cell y:"
	    + alias2(alias1((depth0 != null ? depth0.yCord : depth0), depth0))
	    + " x:"
	    + alias2(alias1((depth0 != null ? depth0.xCord : depth0), depth0))
	    + " value-"
	    + alias2(alias1((depth0 != null ? depth0.intialValue : depth0), depth0))
	    + "\"></li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<!-- "
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cells : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n\n</ul>\n    <table class=\"table\">\n        <tbody>\n            <tr>\n              <td> Board Managment Options </td>\n              <td>   <button type=\"submit\" class=\"col-xs-4 save-board btn btn-default btn-block\">Save this board!</button></td>\n              <td>   <form class='userEvents' id='list-boards'>\n                    <button type=\"submit\" class=\"btn btn-default col-xs-4 btn-block\"> Return to Board List</button>\n                </form></td>\n                <td>  <button type=\"button\" type=\"submit\" class=\"col-xs-4 delete-board btn btn-default btn-block\">Delete Board</button> </td>\n            </tr>\n            <tr>\n            <td>  Animation options:  </td>\n            <td>     <button id=\"button\" type=\"submit\" class=\"animate_board btn btn-default btn-block\">Make the Board Blink</button> </td>\n            <td>     <button id=\"button\" type=\"submit\" class=\"conway_board btn btn-default btn-block\">Shoop It</button> </td>\n            <td>     <button id=\"button\" type=\"submit\" class=\"stop_animation btn btn-default btn-block\">Stop Animation</button> </td>\n            </tr>\n        </tbody>\n    </table>\n    <button id=\"button\" type=\"submit\" class=\"randomize_board btn btn-primary btn-lg btn-block\">Randomize the Board...its the most fun</button>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<h1 class=\"board-title\" id=\"board-title\">Board Title : "
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var saveBoard = function saveBoard(data) {
	  var boardStoreID = board.boardStore.board.id;
	  return $.ajax({
	    method: 'PATCH',
	...
	var saveNewBoard = function saveNewBoard(data) {
	  return $.ajax({
	    method: 'POST',
	...
	// NEED TO REPLACE THE ONE BELOW WITH THE ID OF THE BOARD
	var deleteBoard = function deleteBoard(data) {
	  var boardStoreID = board.boardStore.board.id;
	  return $.ajax({
	    method: 'DELETE',
	    url: config.apiOrigins.production + '/boards/' + boardStoreID,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var listBoardsTemplate = __webpack_require__(45);
	var noBoardsTempleate = __webpack_require__(46);
	var saveMessage = __webpack_require__(47);

	var board = __webpack_require__(38);

	var getGamesSuccesss = function getGamesSuccesss(data) {

	  board.boardsList = data.boards;
	  var boards = board.boardsList;
	  var boardsHTML = void 0;
	  if (boards.length === 0) {
	    boardsHTML = noBoardsTempleate();
	  } else {
	    boardsHTML = listBoardsTemplate({ boards: boards });
	  }
	...
	// }
	var getBoardSuccsess = function getBoardSuccsess(data) {
	...
	var newGameSucess = function newGameSucess(data) {
	  $('.board-list').remove();
	  board.boardStore = data;
	  $('#newGame').modal('hide');
	  $('#myForm')[0].reset();
	...
	var saveGameSuccess = function saveGameSuccess() {
	  var titlePrep = board.boardStore;
	  var title = titlePrep.board.title;
	  var saveMessageHTML = saveMessage({ title: title });
	  $('.board-title').append(saveMessageHTML);
	};

	module.exports = {
	  getGamesSuccesss: getGamesSuccesss,
	  getBoardSuccsess: getBoardSuccsess,
	  newGameSucess: newGameSucess,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li id="
	    ...
	    + " class=\"list_of_boards\"> "
	    + alias2(alias1((depth0 != null ? depth0.title : depth0), depth0))
	    + "</li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<div class=\"board-list\">\n<h2\"board-message\"> Your Boards </h2>\n<ul>\n"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"board-list\">\n<h2 class=\"bg-warning board-message\"> It looks like you are a new user, create a board below to get started </h2>\n</div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<p class=\"save-message\" id=\"board-title\">Save sucess for Board: "
	    + container.escapeExpression(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"title","hash":{},"data":data}) : helper)))
	    + " </p>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class = \"video\">\n<p class=\"bg-danger\"> This is playing b/c you are animating a BOARD</p>\n<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/4vaN01VLYSQ?autoplay=1\" frameborder=\"0\" allowfullscreen></iframe>\n</div>\n";
	},"useData":true});
